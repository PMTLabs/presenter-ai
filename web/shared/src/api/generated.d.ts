export interface paths {
    ...
    "/v1/tools/oauth/client-metadata.json": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/tools/oauth/complete": {
        ...
        get?: never;
        put?: never;
        post: operations["CompleteToolOAuth"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/tools/servers/{id}": {
        ...
        put?: never;
        post?: never;
        delete: operations["DeleteToolServer"];
        options?: never;
        head?: never;
        patch: operations["UpdateToolServer"];
        trace?: never;
    };
    "/v1/tools/servers/{id}/credential": {
        ...
        get?: never;
        put: operations["SaveToolCredential"];
        post?: never;
        delete: operations["DisconnectToolCredential"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/tools/servers/{id}/oauth/start": {
        ...
        get?: never;
        put?: never;
        post: operations["StartToolOAuth"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/tools/servers/{id}/test": {
        ...
        get?: never;
        put?: never;
        post: operations["TestToolServer"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/tools/servers/{id}/tools": {
        ...
        get: operations["ListToolsForServer"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/tools/settings": {
        ...
        get: operations["GetToolSettings"];
        put: operations["UpdateToolSettings"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface components {
    schemas: {
        ...
        ListResponseOfPresentationSummary: {
            items: components["schemas"]["PresentationSummary"][];
            /** Format: int32 */
            page: number | string;
            /** Format: int32 */
        ...
        StartToolOAuthRequest: {
            clientId?: null | string;
            clientSecret?: null | string;
        };
        TestToolServerResponse: {
        ...
        ToolOAuthStartResponse: {
            authorizationUrl?: null | string;
            server?: null | components["schemas"]["ServerView"];
        };
        ToolSettingsResponse: {
            webSearchEnabled: boolean;
        };
        UpdateToolOverrideRequest: {
            alwaysAsk: boolean;
        };
        UpdateToolServerRequest: {
            alwaysAsk?: null | boolean;
            name?: null | string;
        };
...
export interface operations {
    ...
    ListPresentations: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ListResponseOfPresentationSummary"];
                };
            };
    ...
    CompleteToolOAuth: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CompleteToolOAuthRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    UpdateToolServer: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateToolServerRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    SaveToolCredential: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SaveToolCredentialRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    StartToolOAuth: {
        ...
        requestBody?: {
            content: {
                "application/json": null | components["schemas"]["StartToolOAuthRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ToolOAuthStartResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    TestToolServer: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TestToolServerResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    ListToolsForServer: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ToolItemView"][];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    SetToolOverride: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateToolOverrideRequest"];
            };
        };
        responses: {
            /** @description No Content */
